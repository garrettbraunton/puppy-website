    ...
    <div className="rounded-3xl bg-white p-8 text-center shadow-sm md:col-span-3">
      ...
      className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <img
            src="Puppy images/2I7A1368.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1366.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1467.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1448.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1425.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1375.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1391.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1419.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1487.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1497.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1496.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1503.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1518.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />

          <img
            src="Puppy images/2I7A1523.jpg"
            className="h-72 w-full rounded-3xl object-cover"
            alt="Gallery"
          />
